...
function clearBoard(){
  ...
  //Creation des fleches des buttons
  const straightArrow = document.createElement("div");
  straightArrow.setAttribute("class","line");
  nextBtn.appendChild(straightArrow);
  const upArrow = document.createElement("div");
  upArrow.setAttribute("class","line451");
  nextBtn.appendChild(upArrow);
  const downArrow = document.createElement("div");
  downArrow.setAttribute("class","line452");
  nextBtn.appendChild(downArrow);
  confirmBtn.remove();
  resBtn.remove();
